...
def post_details(post_id):
    ...
    return render_template("post_details.html", post=post, user_id=user_id, user=user) 
    # tags = Tag.query.all()
...
def post_create_view(user_id):
    ...
    global current_user_id
    user_id = current_user_id
    return render_template("post_create.html", user_id=user_id)        
...
def post_create(user_id):
    ...
    new_post = Post(post_title=post_title, post_content=post_content, user_id=user_id, created_at=created_at)
